...
- meanings: if DISTINCT MEANING GROUPS are listed in AUTHORITATIVE DATA above, for each group: {"translation": "distinct Ukrainian translation (1-4 words, must differ from others)", "definition": "Nynorsk definition text from the list — Ukrainian translation of that text"}. Use " — " as separator. Omit if no groups listed.
